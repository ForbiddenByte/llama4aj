...
__launch_bounds__(lm_ggml_cuda_get_physical_warp_size(), 1)
...
static void launch_mm_ids_helper(
    ...
    LM_GGML_ASSERT(n_tokens          < (1 << 22) && "too few bits in mm_ids_helper_store");
    LM_GGML_ASSERT(n_expert_used_var < (1 << 10) && "too few bits in mm_ids_helper_store");
    ...
    LM_GGML_ASSERT(nbytes_shared <= smpbo);
