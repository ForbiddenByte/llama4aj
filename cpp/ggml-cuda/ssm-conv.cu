...
static void ssm_conv_f32_cuda(const float * src0, const float * src1, const int src0_nb0, const int src0_nb1,
    ...
    switch (nc) {
        ...
        default: LM_GGML_ABORT("Only support kernel sizes 3, 4, 9 right now.");
    }
}

void lm_ggml_cuda_op_ssm_conv(lm_ggml_backend_cuda_context & ctx, lm_ggml_tensor * dst) {
